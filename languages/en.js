const enUS = {
  ...
  heroTitle: "Backend Engineering, Cloud Security & Secure Architecture",

  heroDescription:
    "Computer Science student focused on Java, Spring ecosystem, API security, DevSecOps and secure architecture.",
