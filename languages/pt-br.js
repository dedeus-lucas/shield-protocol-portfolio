const ptBR = {
  ...
  heroTitle: "Engenharia Backend, Segurança em Cloud & Arquitetura Segura",

  heroDescription:
    "Bacharelando em Ciência da Computação com foco em Java, ecossistema Spring, segurança de APIs, DevSecOps e arquitetura segura.",
  ...
  projectsLabsDescription:
    "Laboratórios focados em backend, APIs seguras, observabilidade, arquitetura e práticas DevSecOps.",
